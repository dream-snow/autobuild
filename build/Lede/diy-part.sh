...
# 旁路由选项
export Gateway_Settings="192.168.100.2"                 # 旁路由设置 IPv4 网关(填入您的网关IP为启用)(填0为不作修改)
...
# 更换固件内核
export Replace_Kernel="5.1"                    # 更换内核版本,在对应源码的[target/linux/架构]查看patches-x.x,看看x.x有啥就有啥内核了(填入内核版本号,填0为不作修改)
